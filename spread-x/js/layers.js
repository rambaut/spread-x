...
const DEFAULT_STYLES = {
  basemap: {
    ...
    graticuleWidth:    0.5,
    graticuleCurvePrecision: 0.2,
    graticuleOpacity:  0.1,
    featuresLayoutOnly: false,
    showGlobe:         true,
    oceanFill:         '#02292e',
    landFill:          '#1a3a2a',
  ...
  geojson: {
    ...
    stroke:      '#2aa198',
    strokeWidth: 1,
    featureHoverFill: 'rgba(120, 205, 255, 0.32)',
    featureHoverStroke: 'none',
    featureHoverStrokeWidth: 1,
    featureSelectFill: 'rgba(255, 196, 77, 0.34)',
